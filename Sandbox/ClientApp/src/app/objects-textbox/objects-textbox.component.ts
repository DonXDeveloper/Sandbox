...
@Component({
  selector: 'app-objects-textbox',
  templateUrl: './objects-textbox.component.html',
  styleUrls: ['./objects-textbox.component.scss']
})

export class ObjectsTextboxComponent implements OnInit {
  ...
  objectChanged(newValue: string) {
    //console.log(` formatTypeId ${this.formatTypeId}: ${this.decimalPlaces}`);
